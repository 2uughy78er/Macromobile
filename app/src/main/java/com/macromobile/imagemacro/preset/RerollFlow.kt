...
object RerollFlow {
     ...
     * 버튼 하나.
     *
     * [file] 은 그림 파일 번호다. 여러 단계가 **완전히 같은 버튼**(예: 대화상자 [확인])을
     * 쓸 때 같은 그림을 가리키게 한다. 그림은 하나만 두고, 찾는 영역은 단계마다 갖는다.
     */
    private fun img(n: Int, name: String, x: Int, y: Int, w: Int, h: Int, file: Int = n) =
        ImageTap(name, "step_%02d.png".format(file), Roi(x, y, w, h))
    ...
    val STEPS: List<RerollStep> = listOf(
        ...
        img(8, "튜토리얼 스킵 - 확인", 1166, 868, 232, 72),
        ...
        img(16, "라인업 저장 - 확인", 1166, 868, 232, 72, file = 8),
        ...
        img(24, "연속 스카우트 - 확인", 1166, 868, 232, 72, file = 8),
